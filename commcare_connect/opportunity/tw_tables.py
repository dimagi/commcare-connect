...
class OpportunitiesListTable(tables.Table):
    ...
    entityStatus = tables.TemplateColumn(
        ...
        template_code="""
            <div class="flex justify-center w-[178px] text-sm font-normal truncate text-brand-deep-purple overflow-clip overflow-ellipsis">
               {% if value %}
              {% if value == 'active' %}
                  {% include "ccc_app/components/badges/badge_sm.html" with bg_color='green-600' bg_opacity='20' text='active' text_color='green-600' %}
              {% elif value == 'inactive' %}
                  {% include "ccc_app/components/badges/badge_sm.html" with bg_color='orange-600' bg_opacity='25' text='inactive' text_color='orange-600' %}
              {% elif value == 'ended' %}
                  {% include "ccc_app/components/badges/badge_sm.html" with bg_color='slate-100' bg_opacity='100' text='ended' text_color='slate-400' %}
              {% endif %}
              {% endif%}
            </div>
        """,
    ...
    pendingInvites = tables.TemplateColumn(
        ...
        template_code="""
            ...
            {% if value %}
              {% include "ccc_app/components/dropdowns/text_button_dropdown.html" with text=value.count list=value.list styles='text-sm' %}
            {% endif%}
            </div>
        """,
    )
    ...
    paymentsDue = tables.TemplateColumn(
        ...
        template_code="""
          <div class="flex justify-center w-40 text-sm font-normal truncate text-brand-deep-purple overflow-clip overflow-ellipsis">
               {% if value %}
              {% include "ccc_app/components/dropdowns/text_button_dropdown.html" with text=value.amount list=value.list styles='text-sm' %}
          {% endif%}
          </div>
        """,
    )
...
#         orderable=False,
#         template_code='''
#             <div class="relative flex justify-start text-sm font-normal text-brand-deep-purple w-72">
#                 {% if value %}
#                     {% for flag in value|slice:":2" %}
...
#     def render_index(self, value, record):
#         return format_html('''
#             <div class="flex justify-center w-12 text-sm font-normal text-brand-deep-purple">
#                 <span x-show="!hovered && !isRowSelected({})">{}</span>
#                 <i x-show="hovered || isRowSelected({})"
#                    :class="isRowSelected({}) ? 'fa-regular fa-square-check' : 'fa-regular fa-square'"
#                    class="cursor-pointer text-brand-deep-purple"
#                    x-on:click="hovered && toggleRow({})"></i>
#             </div>
...
#     def render_time(self, value):
#         return format_html(
#             '<div class="flex justify-start text-sm font-normal text-brand-deep-purple w-28">{}</div>',
#             value
#         )
...
#         return format_html(
#             '''
#             <div class="relative flex justify-start w-4 text-sm font-normal text-brand-deep-purple">
#             <i class="fa-light fa-flag-swallowtail"></i>
#             </div>
#             '''
#         )
...
#             'class': 'flex w-full justify-between gap-x-4 p-3 bg-white hover:bg-gray-100 relative transition-colors duration-300',
#         }
#         sequence = ('index', 'opportunity', 'entityType', 'entityStatus', 'program', 'startDate', 'endDate', 'pendingInvites', 'inactiveWorkers', 'pendingApprovals', 'paymentsDue')
...
#     def render_opportunity(self, value):
#         return format_html(
#             '<div class="flex justify-start w-40 text-sm font-normal truncate text-brand-deep-purple overflow-clip overflow-ellipsis">{}</div>', value
#         )

#     def render_program(self, value):
#         return format_html(
#             '<div class="flex justify-start text-sm font-normal truncate text-brand-deep-purple overflow-clip overflow-ellipsis w-36">{}</div>', value
#         )

#     def render_startDate(self, value):
#         return format_html(
#             '<div class="flex justify-center w-24 text-sm font-normal truncate text-brand-deep-purple overflow-clip overflow-ellipsis">{}</div>', value
#         )
...
#             <div>
#                 <input type="date"
#                 class="p-2 border rounded focus:border-slate-300 focus:outline-none w-28"
#                 value="{}">
#             </div>
#             ''',
#             value
...
# class WorkerPaymentsTable(tables.Table):
#     index = tables.Column(verbose_name='#', attrs={"td": {"class": "p-0",}})
#     worker = tables.Column(verbose_name='Worker', attrs={"td": {"class": "p-0",}})
#     indicator = tables.TemplateColumn(verbose_name='Indicator',
#                                     attrs={"td": {"class": "p-0",}},
#                                     orderable=False,
#                                     template_code='''
#                                     {% if value %}
...
#                                     ''',
#     )
#     lastActive = tables.Column(verbose_name='Last Active', attrs={"td": {"class": "p-0",}})
#     accrued = tables.Column(verbose_name='Accrued', attrs={"td": {"class": "p-0",}})
#     totalPaid = tables.Column(verbose_name='Total Paid', attrs={"td": {"class": "p-0",}})
#     lastPaid = tables.Column(verbose_name='Last Paid', attrs={"td": {"class": "p-0",}})
#     confirmed = tables.Column(verbose_name='Confirmed', attrs={"td": {"class": "p-0",}})
