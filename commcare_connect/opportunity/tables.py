...
class WorkerTasksVisitTable(tables.Table):
...
class UserVisitVerificationTable(WorkerTasksVisitTable):
    ...
    class Meta(WorkerTasksVisitTable.Meta):
        sequence = ("select",) + WorkerTasksVisitTable.Meta.sequence
