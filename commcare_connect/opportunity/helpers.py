...
class OpportunityData:
    ...
    @staticmethod
    def get_data_qs(organization, opp_ids, can_act_as_program_manager=False):
        ...
        # Show additional details for any org that can act as program manager
        if can_act_as_program_manager:
            deliveries_agg = (
