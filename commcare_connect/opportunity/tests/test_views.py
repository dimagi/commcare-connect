...
from commcare_connect.opportunity.helpers import get_opportunity_dashboard_data
...
from commcare_connect.opportunity.tests.factories import (
    ...
    PaymentUnitFactory,
    UserVisitFactory, LearnModuleFactory, CompletedModuleFactory, UserInviteFactory, PaymentFactory,
    CompletedWorkFactory, AssessmentFactory,
)
