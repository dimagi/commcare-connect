...
from commcare_connect.opportunity.views import (
    ...
    payment_report,
    reject_visits,
    render_payment_import_progress,
    resend_user_invites,
    review_visit_export,
    review_visit_import,
...
urlpatterns = [
    ...
    path("payment_import_status/<slug:task_id>", view=render_payment_import_progress, name="payment_import_status"),
    ...
    path(
        "<slug:opp_id>/task_types/ocs_section/",
        view=TaskTypeOcsSection.as_view(),
        name="task_type_ocs_section",
    ),
