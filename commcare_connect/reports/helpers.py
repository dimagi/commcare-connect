            ...
            data.append(
                {
                    ...
                    "avg_time_to_payment": avg_time_to_payment_data.get(delivery_type_name, timedelta(days=0)),
                    "max_time_to_payment": max_time_to_payment_data.get(delivery_type_name, timedelta(days=0)),
