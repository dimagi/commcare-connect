...
class TestModifyWorkAreaUpdateView(BaseMicroplanningFlagTest):
    ...
    def test_successful_field_updates(self, mock_sync, client, org_user_admin, opportunity):
        ...
        initial_event_count = work_area.expected_visit_count_work_area_group_status_excluded_reason_events.count()
        ...
        events = work_area.expected_visit_count_work_area_group_status_excluded_reason_events
    ...
    def test_no_history_created_when_nothing_changes(self, mock_sync, client, org_user_admin, opportunity):
        ...
        assert response.status_code == 204
        assert (
            work_area.expected_visit_count_work_area_group_status_excluded_reason_events.count() == initial_event_count
        )
