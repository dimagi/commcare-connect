...
from commcare_connect.program.forms import ProgramForm, funder_organizations
...
class TestFunderOrganizations:
    def test_includes_only_funders(self, program_manager_org, funder_org):
        ...
        result = funder_organizations(program_manager_org)
    ...
    def test_excludes_own_organization(self, program_manager_org):
        ...
        assert program_manager_org not in funder_organizations(program_manager_org)
